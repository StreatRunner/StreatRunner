...
void BezierCurve::setPoint(int startingPoint_x, int startingPoint_y, int endPoint_x, int endPoint_y, int turnPoint_x, int turnPoint_y, double speed, int speedLimit)
{
